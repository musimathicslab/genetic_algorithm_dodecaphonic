...
public class Keyboard extends JPanel
{
   ...
   public MainFrame owner = null;

   public Keyboard (final MainFrame owner)
   {
      setLayout (new BorderLayout ());
      //setSize (new Dimension (42*KEY_WIDTH+1, KEY_HEIGHT+1));
      //setPreferredSize (new Dimension (42*KEY_WIDTH+1, KEY_HEIGHT+1));
      setSize (new Dimension (7*KEY_WIDTH+1, KEY_HEIGHT+1));
      setPreferredSize (new Dimension (7*KEY_WIDTH+1, KEY_HEIGHT+1));
      ...
      //for (int i = 0, x = 0; i < 6; i++) 
      for (int i = 3, x = 0; i < 4; i++, x += KEY_WIDTH) 
      {
      ...
      addMouseListener (new MouseAdapter ()
                        {
                            public void mousePressed (MouseEvent e)
                            {
                               ...
                               if (theKey != null)
                               {
                                  ...
                                  owner.addNoteToSeries(theKey.kNum % 12);
   ...
   public void paint (Graphics g)
   {
      ...
      g2.fillRect (0, 0, 7*KEY_WIDTH, KEY_HEIGHT);
   ...
   public boolean turnOn ()
   {
      ...
      // Attempt to load all instruments.
